...
<table style="border-collapse: collapse;" width="100%" align="center"  border="1" class="table">
	...
	<td align="center"><?php echo $no; ?></td>
		...
		<tr style="height:50px;">
			<td colspan="5" align="right" class="info"><b style="margin-right: 3px;">Total Biaya</b></td>

			<td align="center" rowspan="" colspan="2" class="danger"><b>Rp. <?php echo $total+$biaya; ?></b></td>
...
<div style="padding:10px 0 0 23px;">
	...
	<a href="transaksi_detail.php?id_order=<?php echo $id ;?>" class="button round warning btn btn-warning">Kembali</a>
</div>
